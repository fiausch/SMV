...

{
  ...
  private:
	...
	void createLogicalDevice()
	{
		...
		vk::PhysicalDeviceFeatures2 feat2;
		vk::PhysicalDeviceVulkan11Features feat11;
		feat11.shaderDrawParameters = true;
		 vk::PhysicalDeviceVulkan13Features feat13;
		 feat13.synchronization2 = true;
		 feat13.dynamicRendering = true;
		 vk::PhysicalDeviceExtendedDynamicStateFeaturesEXT featEXT;
		 featEXT.extendedDynamicState = true;
		// query for required features (Vulkan 1.1 and 1.3)
		vk::StructureChain<vk::PhysicalDeviceFeatures2, vk::PhysicalDeviceVulkan11Features, vk::PhysicalDeviceVulkan13Features, vk::PhysicalDeviceExtendedDynamicStateFeaturesEXT> featureChain = {
		    feat2,                                  // vk::PhysicalDeviceFeatures2
		    feat11,                              	// vk::PhysicalDeviceVulkan11Features
		    feat13,        							// vk::PhysicalDeviceVulkan13Features
		    featEXT                             	// vk::PhysicalDeviceExtendedDynamicStateFeaturesEXT
		};
	...
	{
		vk::raii::ShaderModule shaderModule = createShaderModule(readFile(RESOURCES_PATH"shaders/slang.spv"));
		...
		vk::PipelineRenderingCreateInfo prInfo{};
		prInfo.colorAttachmentCount = 1;
		prInfo.pColorAttachmentFormats = &swapChainSurfaceFormat.format;
		vk::StructureChain<vk::GraphicsPipelineCreateInfo, vk::PipelineRenderingCreateInfo> pipelineCreateInfoChain = { gpInfo, prInfo};
	...
	void drawFrame()
	{
		...
		const vk::SubmitInfo   submitInfo{1, &*presentCompleteSemaphore[semaphoreIndex], &waitDestinationStageMask, 1, &*commandBuffers[currentFrame], 1, &*renderFinishedSemaphore[imageIndex]};
		queue.submit(submitInfo, *inFlightFences[currentFrame]);

		try
		{
			const vk::PresentInfoKHR presentInfoKHR{1, &*renderFinishedSemaphore[imageIndex], 1, &*swapChain, &imageIndex};
