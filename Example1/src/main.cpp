...
class HelloTriangleApplication
{
  ...
  private:
	...
	void createInstance()
	{
		constexpr vk::ApplicationInfo appInfo{"SMV",
	...
	void createLogicalDevice()
	{
		...
		vk::PhysicalDeviceFeatures2 devicefeat2{};
		vk::PhysicalDeviceVulkan11Features devicefeat11{};
		devicefeat11.shaderDrawParameters = true;
		vk::PhysicalDeviceVulkan13Features devicefeat13{};
		devicefeat13.dynamicRendering = true;
		vk::PhysicalDeviceExtendedDynamicStateFeaturesEXT deviceEXT{};
		deviceEXT.extendedDynamicState = true;
		vk::StructureChain<vk::PhysicalDeviceFeatures2,
		                   vk::PhysicalDeviceVulkan11Features,
		                   vk::PhysicalDeviceVulkan13Features,
		                   vk::PhysicalDeviceExtendedDynamicStateFeaturesEXT>
		    featureChain = {
		        devicefeat2,                                                          // vk::PhysicalDeviceFeatures2
		        devicefeat11,                              // vk::PhysicalDeviceVulkan11Features
		        devicefeat13,        // vk::PhysicalDeviceVulkan13Features
		        deviceEXT                               // vk::PhysicalDeviceExtendedDynamicStateFeaturesEXT
		    };
